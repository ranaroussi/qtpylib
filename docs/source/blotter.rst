...
**Blotter**. A Blotter connects to the broker (in QTPy's case,
...
In QTPy's case, the Blotter handle all of the above, while your
algorithms subscribe to the Blotter's updates via pub/sub
mechanism using ZeroMQ - a blazing fast Message Queue.

.. note::
    QTPy was designed with a **"One Blotter To Rule Them All"**
