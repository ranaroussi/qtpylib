...
.. note::
    QTPy requires `IbPy <https://github.com/blampe/IbPy>`_, which, for some reason,
...
In order for QTPy to be able to subscribe to market data and submit orders,
